...
#define DEVICE_NAME "STRWHL_SML" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "90ab517b-d081-4849-9ee5-bbe5cf956c7f" //{"UniqueId":"90ab517b-d081-4849-9ee5-bbe5cf956c7f","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
...
// 0 disabled, > 0 enabled
#define WS2812B_RGBLEDCOUNT 11       //{"Group":"WS2812B RGB Leds","Name":"WS2812B_RGBLEDCOUNT","Title":"WS2812B RGB leds count","DefaultValue":"0","Type":"int","Max":150}
...
#define BUTTON_PIN_1 11         //{"Name":"BUTTON_PIN_1","Title":"1'st Additional button digital pin","DefaultValue":"3","Type":"pin;Button 1","Condition":"ENABLED_BUTTONS_COUNT>=1"}
...
#define BUTTON_PIN_2 10         //{"Name":"BUTTON_PIN_2","Title":"2'nd Additional button digital pin","DefaultValue":"3","Type":"pin;Button 2","Condition":"ENABLED_BUTTONS_COUNT>=2"}
...
#define BUTTON_PIN_3 8          //{"Name":"BUTTON_PIN_3","Title":"3'rd Additional button digital pin","DefaultValue":"3","Type":"pin;Button 3","Condition":"ENABLED_BUTTONS_COUNT>=3"}
...
#define BUTTON_PIN_4 9          //{"Name":"BUTTON_PIN_4","Title":"4'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 4","Condition":"ENABLED_BUTTONS_COUNT>=4"}
...
#define BUTTON_PIN_5 18         //{"Name":"BUTTON_PIN_5","Title":"5'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 5","Condition":"ENABLED_BUTTONS_COUNT>=5"}
...
#define BUTTON_PIN_6 13         //{"Name":"BUTTON_PIN_6","Title":"6'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 6","Condition":"ENABLED_BUTTONS_COUNT>=6"}
...
#define BUTTON_PIN_7 6          //{"Name":"BUTTON_PIN_7","Title":"7'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 7","Condition":"ENABLED_BUTTONS_COUNT>=7"}
...
#define BUTTON_PIN_8 16         //{"Name":"BUTTON_PIN_8","Title":"8'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 8","Condition":"ENABLED_BUTTONS_COUNT>=8"}
...
#define BUTTON_PIN_9 17         //{"Name":"BUTTON_PIN_9","Title":"9'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 9","Condition":"ENABLED_BUTTONS_COUNT>=9"}
...
#define BUTTON_PIN_10 2         //{"Name":"BUTTON_PIN_10","Title":"10'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 10","Condition":"ENABLED_BUTTONS_COUNT>=10"}
...
#define BUTTON_PIN_11 5         //{"Name":"BUTTON_PIN_11","Title":"11'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 11","Condition":"ENABLED_BUTTONS_COUNT>=11"}
...
#define ENCODER1_CLK_PIN 0           //{"Name":"ENCODER1_CLK_PIN","Title":"Encoder 1 output A (CLK) pin","DefaultValue":"7","Type":"pin;Encoder 1 CLK","Condition":"ENABLED_ENCODERS_COUNT>0"}
#define ENCODER1_DT_PIN 1            //{"Name":"ENCODER1_DT_PIN","Title":"Encoder 1 output B (DT) pin","DefaultValue":"8","Type":"pin;Encoder 1 DT","Condition":"ENABLED_ENCODERS_COUNT>0"}
#define ENCODER1_BUTTON_PIN 4        //{"Name":"ENCODER1_BUTTON_PIN","Title":"Encoder 1 button (SW) pin","DefaultValue":"9","Type":"pin;Encoder 1 SWITCH","Condition":"ENABLED_ENCODERS_COUNT>0","Min":-1}
...
#define ENCODER2_CLK_PIN 23          //{"Name":"ENCODER2_CLK_PIN","Title":"Encoder 2 output A (CLK) pin","DefaultValue":"11","Type":"pin;Encoder 2 CLK","Condition":"ENABLED_ENCODERS_COUNT>1"}
#define ENCODER2_DT_PIN 21           //{"Name":"ENCODER2_DT_PIN","Title":"Encoder 2 output B (DT) pin","DefaultValue":"12","Type":"pin;Encoder 2 DT","Condition":"ENABLED_ENCODERS_COUNT>1"}
#define ENCODER2_BUTTON_PIN 22       //{"Name":"ENCODER2_BUTTON_PIN","Title":"Encoder 2 button (SW) pin","DefaultValue":"13","Type":"pin;Encoder 2 SWITCH","Condition":"ENABLED_ENCODERS_COUNT>1","Min":-1}
...
#define ENCODER3_CLK_PIN 19          //{"Name":"ENCODER3_CLK_PIN","Title":"Encoder 3 output A (CLK) pin","DefaultValue":"7","Type":"pin;Encoder 3 CLK","Condition":"ENABLED_ENCODERS_COUNT>2"}
#define ENCODER3_DT_PIN 20           //{"Name":"ENCODER3_DT_PIN","Title":"Encoder 3 output B (DT) pin","DefaultValue":"8","Type":"pin;Encoder 3 DT","Condition":"ENABLED_ENCODERS_COUNT>2"}
#define ENCODER3_BUTTON_PIN 12       //{"Name":"ENCODER3_BUTTON_PIN","Title":"Encoder 3 button (SW) pin","DefaultValue":"9","Type":"pin;Encoder 3 SWITCH","Condition":"ENABLED_ENCODERS_COUNT>2","Min":-1}
...
#define BMATRIX_COL1 8         //{"Name":"BMATRIX_COL1","Title":"Column 1 pin","DefaultValue":"2","Type":"pin;Button M. Col 1","Condition":"ENABLED_BUTTONMATRIX>0 && BMATRIX_COLS>=1"}
#define BMATRIX_COL2 9         //{"Name":"BMATRIX_COL2","Title":"Column 2 pin","DefaultValue":"3","Type":"pin;Button M. Col 2","Condition":"ENABLED_BUTTONMATRIX>0 && BMATRIX_COLS>=2"}
#define BMATRIX_COL3 5         //{"Name":"BMATRIX_COL3","Title":"Column 3 pin","DefaultValue":"4","Type":"pin;Button M. Col 3","Condition":"ENABLED_BUTTONMATRIX>0 && BMATRIX_COLS>=3"}
...
#define BMATRIX_ROW1 13        //{"Name":"BMATRIX_ROW1","Title":"Row 1 pin","DefaultValue":"6","Type":"pin;Button M. Row 1","Condition":"ENABLED_BUTTONMATRIX>0 && BMATRIX_ROWS>=1"}
...
#define BMATRIX_ROW3 10        //{"Name":"BMATRIX_ROW3","Title":"Row 3 pin","DefaultValue":"8","Type":"pin;Button M. Row 3","Condition":"ENABLED_BUTTONMATRIX>0 && BMATRIX_ROWS>=3"}
...
#define ENC_LEFT_A A5
#define ENC_LEFT_B A3
...
int right_encoder_PinALast = HIGH;
int right_n = HIGH;

int left_encoder_Pos = 0;
int left_encoder_PinALast = HIGH;
int left_n = HIGH;

volatile boolean f10ms = LOW;
volatile boolean f100ms = LOW;
volatile boolean f_sw_side_push = false;


volatile int cnt10ms = 0;
volatile int counter = 0;
volatile int Val1=0;
volatile int8_t Val2=0;          
...
unsigned char butdat_pc = 0;     // Button data
unsigned char prvdat_pc = 0;     // Previous button data
unsigned char button_pc = 0;     // Button data store
unsigned char prvbut_pc = 0;     // Previous button data
unsigned char presdb_pc = 0;     // Pressed button
unsigned char vdcnt_pc = 0;      // Valid data counter
unsigned char lvdcnt_pc = 0;     // Long valid data counter


unsigned char butdat_pe = 0;     // Button data
unsigned char prvdat_pe = 0;     // Previous button data
unsigned char button_pe = 0;     // Button data store
unsigned char prvbut_pe = 0;     // Previous button data
unsigned char presdb_pe = 0;     // Pressed button
unsigned char vdcnt_pe = 0;      // Valid data counter
unsigned char lvdcnt_pe = 0;     // Long valid data counter


unsigned char butdat_pf = 0;     // Button data
unsigned char prvdat_pf = 0;     // Previous button data
unsigned char button_pf = 0;     // Button data store
unsigned char prvbut_pf = 0;     // Previous button data
unsigned char presdb_pf = 0;     // Pressed button
unsigned char vdcnt_pf = 0;      // Valid data counter
unsigned char lvdcnt_pf = 0;     // Long valid data counter
...
void pin_init(void)
{
  ...
  DDRB &= ~(1<<PB4);    //Configure PORTB pin 4 as an input  --- BUTTON 
  PORTB |= (1<<PB4);    //Activate pull-ups in PORTB pin 4

  DDRB &= ~(1<<PB5);    //Configure PORTB pin 5 as an input  --- BUTTON 
  PORTB |= (1<<PB5);    //Activate pull-ups in PORTB pin 5

  DDRB &= ~(1<<PB6);    //Configure PORTB pin 6 as an input  --- BUTTON 
  PORTB |= (1<<PB6);    //Activate pull-ups in PORTB pin 6

  DDRB &= ~(1<<PB7);    //Configure PORTB pin 7 as an input  --- BUTTON 
  PORTB |= (1<<PB7);    //Activate pull-ups in PORTB pin 7



  DDRD &= ~(1<<PD1);    //Configure PORTD pin 1 as an input  --- BUTTON 
  PORTD |= (1<<PD1);    //Activate pull-ups in PORTD pin 1

  DDRD &= ~(1<<PD4);    //Configure PORTD pin 4 as an input  --- BUTTON 
  PORTD |= (1<<PD4);    //Activate pull-ups in PORTD pin 4

  DDRD &= ~(1<<PD5);    //Configure PORTD pin 5 as an input  --- BUTTON 
  PORTD |= (1<<PD5);    //Activate pull-ups in PORTD pin 5

  DDRD &= ~(1<<PD6);    //Configure PORTD pin 6 as an input  --- BUTTON 
  PORTD |= (1<<PD6);    //Activate pull-ups in PORTD pin 6

  DDRD &= ~(1<<PD7);    //Configure PORTD pin 7 as an input  --- BUTTON 
  PORTD |= (1<<PD7);    //Activate pull-ups in PORTD pin 7


  DDRC &= ~(1<<PC6);    //Configure PORTC pin 6 as an input  --- BUTTON 
  PORTC |= (1<<PC6);    //Activate pull-ups in PORTC pin 6
  
  DDRC &= ~(1<<PC7);    //Configure PORTC pin 7 as an input  --- BUTTON 
  PORTC |= (1<<PC7);    //Activate pull-ups in PORTC pin 7


  DDRE &= ~(1<<PE6);    //Configure PORTE pin 6 as an input  --- BUTTON 
  PORTE |= (1<<PE6);    //Activate pull-ups in PORTE pin 6


  DDRF &= ~(1<<PF1);    //Configure PORTF pin 1 as an input  --- BUTTON 
  PORTF |= (1<<PF1);    //Activate pull-ups in PORTF pin 1  

  DDRF &= ~(1<<PF7);    //Configure PORTF pin 7 as an input  --- BUTTON 
  PORTF |= (1<<PF7);    //Activate pull-ups in PORTF pin 7 
  ...
  DDRD &= ~(1<<PD2);    //Configure PORTD pin 1 as an input  --- BUTTON 
  DDRD &= ~(1<<PD3);    //Configure PORTD pin 1 as an input  --- BUTTON   
}
...
void btn_ex_4_prsd(void)
{
  gp.setButtonState(1, true);
}
void btn_ex_4_rlsd(void)
{
...
void sw_b_rlsd(void)
{
  f_sw_side_push = false;
  gp.setButtonState(2, false);
}


void btn_1_prsd(void)
{
  gp.setButtonState(3, true);
}
void btn_1_rlsd(void)
{
  gp.setButtonState(3, false);
}

void btn_2_prsd(void)
{
  gp.setButtonState(4, true);
}
void btn_2_rlsd(void)
{
...
void sw_pos_1_prsd(void)
{
  gp.setButtonState(5, true);
}
void sw_pos_1_rlsd(void)
{
  gp.setButtonState(5, false);
}


void sw_push_prsd(void)
{
  if(!f_sw_side_push)
  {
...
void enc_right_prsd(void)
{
  gp.setButtonState(9, true);
}
void enc_right_rlsd(void)
{
  gp.setButtonState(9, false);
}

void btn_ex_2_prsd(void)
{
  gp.setButtonState(10, true);
}
void btn_ex_2_rlsd(void)
{
...
void sw_pos_2_prsd(void)
{
  gp.setButtonState(12, true);
}
void sw_pos_2_rlsd(void)
{
...
void enc_left_prsd(void)
{
  gp.setButtonState(14, true);
}
void enc_left_rlsd(void)
{
...
void butread_pc(void)
{
  ...
  if (butdat_pc==prvdat_pc)
  {
    vdcnt_pc++;
    if (button_pc != butdat_pc)     //Long button control
    {
      if (vdcnt_pc == 5)     //5 * 10ms = 50ms debounce
      {      
        vdcnt_pc = 0;
        prvbut_pc = button_pc;
        button_pc = butdat_pc;
        presdb_pc = (butdat_pc ^ prvbut_pc) & prvbut_pc;     
        if (presdb_pc != 0)
        {
          if (presdb_pc & 0x80)       
          {
...
void butread_pe(void)
{
  ...
  if (butdat_pe==prvdat_pe)
  {
    vdcnt_pe++;
    if (button_pe != butdat_pe)     //Long button control
    {
      if (vdcnt_pe == 5)     //5 * 10ms = 50ms debounce
      {      
        vdcnt_pe = 0;
        prvbut_pe = button_pe;
        button_pe = butdat_pe;
        presdb_pe = (butdat_pe ^ prvbut_pe) & prvbut_pe;     
        if (presdb_pe != 0)
        {
          if (presdb_pe & 0x80)       
          {
...
void butread_pf(void)
{
  ...
  if (butdat_pf==prvdat_pf)
  {
    vdcnt_pf++;
    if (button_pf != butdat_pf)     //Long button control
    {
      if (vdcnt_pf == 5)     //5 * 10ms = 50ms debounce
      {      
        vdcnt_pf = 0;
        prvbut_pf = button_pf;
        button_pf = butdat_pf;
        presdb_pf = (butdat_pf ^ prvbut_pf) & prvbut_pf;     
        if (presdb_pf != 0)
        {
          if (presdb_pf & 0x80)       
          {
...
void read_encoder_right(void) {
  right_n = digitalRead(ENC_RIGHT_A);
  if ((right_encoder_PinALast == HIGH) && (right_n == LOW)) 
  {  
    if (digitalRead(ENC_RIGHT_B) == HIGH) {
        gp.setButtonState(16, true);
        delay(50);
        gp.setButtonState(16, false);
    } 
    else 
    {
  ...
  if ((right_encoder_PinALast == LOW) && (right_n == HIGH)) 
  { 
  ...
  right_encoder_PinALast = right_n;
}

void read_encoder_left(void) {
  left_n = digitalRead(ENC_LEFT_A);
  if ((left_encoder_PinALast == HIGH) && (left_n == LOW)) 
  {  
  ...
  if ((left_encoder_PinALast == LOW) && (left_n == HIGH)) 
  { 
...
void sw_read_encoder(void) {
  ...
  {  
    if (digitalRead(SW_ENC_B) == HIGH) {
        gp.setButtonState(20, true);
        delay(50);
        gp.setButtonState(20, false);
    } 
    else 
    {
        gp.setButtonState(19, true);
        delay(50);
        gp.setButtonState(19, false);
    }
  }
